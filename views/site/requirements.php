...
<div>
    ...
    <div>
        <ol>
            ...
            <li>Пройти регистрацию на сайте и зайти в свой <a href="/web/site/sign-up">Личный кабинет</a>.
            ...
            <li>После УСПЕШНОЙ проверки статьи статус заявки меняется на <i>“Статья прошла проверку на оригинальность”.</i> Далее необходимо ЗАГРУЗИТЬ комплект документов:
                <ul>
                    ...
                    <li>файл подписанного / согласованного экспертного заключения (ЭЗ) (формат *pdf/*jpeg) <a href="\web\Templates\Шаблон ЭЗ.docx">Скачать шаблон</a>
