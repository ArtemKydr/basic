...
<div>
    ...
    <div>
        <ol>
            <li>Подготовить статью согласно <a href="\web\Templates\Trebovania_k_statye_Almanakh_2023_1.docx">Требованиям</a>.
    ...
    <div>
        <ul>
            <li><b>Статья на рассмотрении</b> - присваивается после отправки файла статьи для проверки на оригинальность (антиплагиат).
