...
<div>
    ...
    <div>
        <ol>
            <li>Подготовить статью согласно требованиям.
            <li>Пройти регистрацию на сайте и зайти в свой личный кабинет (ЛК).
            ...
            <li>После УСПЕШНОЙ проверки статьи статус заявки меняется на <i>“Статья прошла проверку на оригинальность”.</i> Далее необходимо ЗАГРУЗИТЬ комплект документов:
                <ul>
                    ...
                    <li>файл подписанного / согласованного экспертного заключения (ЭЗ) (формат *pdf/*jpeg)
                    <li>Шаблон экспертного заключения для сторонних участников.
                </ul>
                <b>Для студентов из ИТМО ЭЗ</b> подается через личный кабинет ИСУ. Обращаем внимание, что время согласования ЭЗ  в среднем составляет <b>7 рабочих дней.</b>
            ...
            <li> <a href="">Рецензия на статью</a> . Рецензентом может быть научный сотрудник как ИТМО, так и сторонних организаций, являющийся специалистом в данной научной области. Рецензентом НЕ может быть научный руководитель, соавтор или человек, не имеющий ученой степени.
